      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col mb-4">
              <label class="form-label">Fecha</label>
              <input class="form-control" type="date" id="editEventDate">
            </div>
          </div>
          ...
          <div class="row">
            <div class="col mb-4">
              <label for="defaultSelect" class="form-label">Estado</label>
          ...
          <div class="row">
            <div class="col mb-4">
              <label class="form-label">Servicios</label>
              <select id="editServiceSelect" class="select2 form-select" multiple="multiple">
                {{-- Options se cargan dinámicamente --}}
              </select>
            </div>
          </div>
